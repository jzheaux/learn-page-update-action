...
function main() {
    ...
    const refdocUrl = refDocUrlTemplate.replace(/{project}|{slug}/g, slug).replace('{version}', version);
    const apidocUrl = apiDocUrlTemplate.replace(/{project}|{slug}/g, slug).replace('{version}', version);
    ...
    syncReleases(latestRelease, documentationPath, refDocUrlTemplate.replace(/{project}|{slug}/g, slug), apiDocUrlTemplate.replace(/{project}|{slug}/g, slug));
}
