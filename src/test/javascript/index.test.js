            ...
            expect(content).toEqual([
                {
                    version: "1.2.4-SNAPSHOT",
                    isAntora: true,
                    referenceDocUrl: "https://docs.spring.io/my-project/reference/1.2.4-SNAPSHOT/index.html",
                    apiDocUrl: "https://docs.spring.io/my-project/docs/1.2.4-SNAPSHOT/javadoc-api",
                    status: "SNAPSHOT",
                    current: false
                },
                {
                    version: "1.2.3",
                    isAntora: true,
                    referenceDocUrl: "https://docs.spring.io/my-project/reference/1.2.3/index.html",
                    apiDocUrl: "https://docs.spring.io/my-project/docs/1.2.3/javadoc-api",
                    status: "GENERAL_AVAILABILITY",
                    current: true
                }
            ]);
